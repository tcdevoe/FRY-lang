...
Performing any sort of arithemetic operation on an Integer and floating point number has a floating point result. For example:
\begin{lstlisting}
float f = 5.25
int i = 2
Write(stdout, f*i)
